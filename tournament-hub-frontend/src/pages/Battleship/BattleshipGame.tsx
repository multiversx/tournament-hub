        ...
        if (gameState.phase === 'setup' && board === 'my') {
            if (selectedShip && !isShipPlaced(selectedShip.type)) {
                ...
                if (isValidShipPlacement(x, y, selectedShip, shipOrientation)) {
                    ...
                    // Show error popup for invalid placement
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-lg p-6 max-w-md mx-4 shadow-xl">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg font-semibold text-gray-900">Invalid Ship Placement</h3>
                            </div>
                            <p className="text-gray-600 mb-6">
                                The ship cannot be placed there. Make sure:
                            </p>
                            <ul className="text-sm text-gray-600 mb-6 space-y-1">
                                <li>• The ship fits entirely within the board</li>
                                <li>• The ship doesn't overlap with existing ships</li>
                                <li>• There's enough space for the ship's size</li>
                            </ul>
                            <div className="flex justify-end">
                                <button
                                    onClick={() => setShowPlacementError(false)}
